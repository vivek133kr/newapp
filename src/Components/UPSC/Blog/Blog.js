      ...
      {data.results.length > 0 && (
        <div className={styles["imageBox"]}>
          <div
            ...
            onClick={() =>
              router.push(`/scholarships/upsc/blog/${publishData[0].slug}`)
            }
          >
            <img
              src={
          ...
          >
            <img
              onClick={() =>
                router.push(`/scholarships/upsc/blog/${publishData[1].slug}`)
              }
            ...
            <img
              onClick={() =>
                router.push(`/scholarships/upsc/blog/${publishData[2].slug}`)
              }
